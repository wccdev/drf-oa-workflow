    ...
    'rightMenus': [
        {
            ...
            'isTest': True,
            'isTop': '1',
            'menuFun': 'doSubmitNoBack()',
            'menuIcon': 'icon-workflow-Right-menu-Approval',
            'menuName': '提交',
            'order': 0.0,
            'systemMenuType': 'SUBMIT',
            'systemSmallType': 0,
            'type': 'BTN_SUBMIT',
        },
        {
        ...
        },
        {
            ...
            'isTop': '1',
            'menuFun': 'doReviewE9()',
            'menuIcon': 'icon-workflow-Right-menu-Turn-to-do',
            'menuName': '转发',
            'order': 2.0,
            'systemMenuType': 'FORWARD',
            'systemSmallType': 0,
            'type': 'BTN_FORWARD',
        },
        {
            ...
            'isTop': '0',
            'menuFun': 'doDelete()',
            'menuIcon': 'icon-workflow-Right-menu-delete',
            'menuName': '删除',
            'order': 3.0,
            'systemMenuType': 'DODELETE',
            'systemSmallType': 0,
            'type': 'BTN_DODELETE',
        },
        {
            ...
            'isTest': True,
            'isTop': '0',
            'menuFun': 'doPrintRequest()',
            'menuIcon': 'icon-workflow-Right-menu-Print-log',
            'menuName': '打印',
            'order': 4.0,
            'systemMenuType': 'PRINT',
            'systemSmallType': 0,
            'type': 'BTN_PRINT',
        },
        {
            ...
            'isTest': True,
            'isTop': '0',
            'menuFun': 'doPrintViewLog()',
            'menuIcon': 'icon-workflow-Right-menu-Print-log2',
            'menuName': '打印日志',
            'order': 5.0,
            'systemMenuType': 'PRINT_LOG',
            'systemSmallType': 0,
            'type': 'BTN_COLLECT',
        },
    ],
